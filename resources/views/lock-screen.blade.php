                        ...
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                <div class="mb-8 text-center">
                                    ...
                                    <p class="mt-1 text-gray-500 dark:text-zinc-100/60">Enter your password to unlock the
                                        screen!</p>
                                </div>

                                <div class="pt-2 my-5 text-center ">
                                    <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}"
                                        class="w-16 h-16 p-1 mx-auto border rounded-full dark:border-zinc-600"
                                        alt="thumbnail">
                                    <h5 class="mt-3 text-gray-600 text-15 dark:text-gray-100">Shawn</h5>
                                </div>

                                <form class="pt-2 mt-4" action="index">
                                    <div class="mb-6">
                                        <label
                                            class="block mb-2 font-medium text-gray-600 dark:text-zinc-100">Password</label>
                                        <input type="password"
