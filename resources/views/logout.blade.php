                    ...
                    <div class="w-full p-10 bg-white xl:p-12 dark:bg-zinc-800">
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                <div>
                                    <div
                                        class="w-20 h-20 mx-auto text-center rounded-full bg-violet-500/5 text-primary dark:bg-zinc-700">
                                        <i class="bx bxs-user text-4xl leading-[2.2] text-violet-500"></i>
                                    </div>
                                </div>

                                <div class="mt-6 text-center">
                                    <h5 class="text-gray-700 dark:text-gray-100">You are Logged Out</h5>
                                    <p class="mt-2 text-gray-500 text-15 dark:text-zinc-100/60">Thank you for using <span
                                            class="font-semibold text-gray-800 dark:text-gray-100">Minia</span></p>
                                </div>

                                <div class="mt-5">
                                    <a href="{{ url('auth-login') }}"
                                        class="btn border-transparent bg-violet-500 w-full py-2.5 text-white shadow-md shadow-violet-200 dark:shadow-zinc-600">Sign
                                        In</a>
                                </div>

                                <div class="mt-12 text-center">
                                    <p class="text-gray-500 dark:text-zinc-100/60">Don't have an account ? <a
                                            href="{{ url('login') }}" class="font-semibold text-violet-500"> Signup </a> </p>
                                </div>
                            </div>
