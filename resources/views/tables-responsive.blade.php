    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <!-- page title -->
                <x-page-title title="Responsive Tables" pagetitle="Tables" />

                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12">
                        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                            <div class="card-body border-b border-gray-100 dark:border-zinc-600">
                                <h6 class="mb-1 text-gray-700 text-15 dark:text-gray-100">Example</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-rep-plugin">
                                    <div class="mb-0 table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table w-full text-left table-striped">
                                            <thead class="flex">
                                            ...
                                            <tbody>
                                                <tr
                                                    class="border-b border-gray-50 dark:border-zinc-600 bg-gray-50/30 dark:bg-zinc-700/50 dark:text-zinc-100">
                                                ...
                                                <tr
                                                    class="border-b border-gray-50 dark:border-zinc-600 bg-gray-50/30 dark:bg-zinc-700/50 dark:text-zinc-100">
                                                    <th class="p-3">AMZN <span class="co-name">Amazon.com Inc.</span>
                                                    </th>
                                                ...
                                                <tr class="border-b border-gray-50 dark:border-zinc-600 dark:text-zinc-100">
                                                    <th class="p-3">ORCL <span class="co-name">Oracle Corporation</span>
                                                    </th>
                                                ...
                                                <tr
                                                    class="border-b border-gray-50 dark:border-zinc-600 bg-gray-50/30 dark:bg-zinc-700/50 dark:text-zinc-100">
                                                    <th class="p-3">MSFT <span class="co-name">Microsoft
                                                            Corporation</span></th>
                                                ...
                                                <tr class="border-b border-gray-50 dark:border-zinc-600 dark:text-zinc-100">
                                                    <th class="p-3">CSCO <span class="co-name">Cisco Systems, Inc.</span>
                                                    </th>
                                                ...
                                                <tr
                                                    class="border-b border-gray-50 dark:border-zinc-600 dark:text-zinc-100">
                                                    <th class="p-3">AMZN <span class="co-name">Amazon.com Inc.</span>
                                                    </th>
                                                    <td class="p-3">191.55</td>
                                                    <td class="p-3">12:23PM</td>
                                                ...
                                                <tr
                                                    class="border-b border-gray-50 dark:border-zinc-600 bg-gray-50/30 dark:bg-zinc-700/50 dark:text-zinc-100">
                                                    <th class="p-3">ORCL <span class="co-name">Oracle
                                                            Corporation</span></th>
                                                    <td class="p-3">31.15</td>
                                                    <td class="p-3">12:44PM</td>
                                                    <td class="p-3">1.41 (4.72%)</td>
                                                ...
                                                <tr
                                                    class="border-b border-gray-50 dark:border-zinc-600 bg-gray-50/30 dark:bg-zinc-700/50 dark:text-zinc-100">
                                                    <th class="p-3">CSCO <span class="co-name">Cisco Systems,
                                                            Inc.</span></th>
                                                    <td class="p-3">18.65</td>
                                                    <td class="p-3">12:45PM</td>
                                                    <td class="p-3">0.97 (5.49%)</td>
