                    ...
                    <div class="flex h-[90vh] flex-col">
                        ...
                        <div class="my-auto">
                            <div class="text-center">
                                ...
                                <p class="mt-1 text-gray-500 dark:text-zinc-100/60">Get your free Minia account now.</p>
                            </div>

                            <form class="pt-2 mt-4" action="index">
                                <div class="mb-4">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-gray-100">Email</label>
                                    <input type="text"
                                        class="w-full py-1.5 border-gray-100 rounded placeholder:text-13 bg-gray-50/30 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-gray-100 dark:placeholder:text-zinc-100/60 focus:ring focus:ring-violet-500/20 focus:border-violet-100 text-13"
                                ...
                                <div class="mb-6 row">
                                    <div class="col">
                                        <div>
                                            <p class="text-gray-700 dark:text-zinc-100/60">By registering you agree to
                            ...
                            <div class="pt-2 mt-4 text-center">
                                <div>
                                    <h6 class="mb-3 font-medium text-gray-500 text-14 dark:text-zinc-100/60">- Sign in
                                        with -</h6>
                                </div>
                            ...
                            <div class="mt-12 text-center">
                                <p class="text-gray-500 dark:text-zinc-100/60">Already have an account ? <a
                                        href="{{ url('login') }}" class="font-semibold text-violet-500"> Login </a> </p>
                            </div>
                        </div>
