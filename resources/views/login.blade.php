                        ...
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="mt-2 mb-4 text-gray-500 dark:text-gray-100/60">Sign in to continue to Minia.
                                    </p>
                                </div>

                                <form class="pt-2" action="index">
                                    <div class="mb-4">
                                        <label
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="flex">
                                            <input type="password"
                                                class="w-full py-1.5 border-gray-50 rounded ltr:rounded-r-none rtl:rounded-l-none bg-gray-50/30 placeholder:text-13 text-13 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-gray-100 dark:placeholder:text-zinc-100/60 focus:ring focus:ring-violet-500/20 focus:border-violet-100"
                                                placeholder="Enter password" aria-label="Password"
                                                aria-describedby="password-addon">
                                            <button
                                                class="px-4 border rounded border-gray-50 bg-gray-50 ltr:rounded-l-none rtl:rounded-r-none ltr:border-l-0 rtl:border-r-0 dark:bg-zinc-700 dark:border-zinc-600 dark:text-gray-100"
                                ...
                                <div class="mt-12 text-center">
                                    <p class="text-gray-500 dark:text-gray-100">Don't have an account ? <a
                                            href="{{ url('register') }}" class="font-semibold text-violet-500"> Signup now </a> </p>
                                </div>
                            </div>
