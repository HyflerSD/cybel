        ...
        <div class="h-screen md:overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-12 ">
                <div class="relative z-50 col-span-12 md:col-span-5 lg:col-span-4 xl:col-span-3">
                    <div class="w-full p-10 bg-white xl:p-12">
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                ...
                                <div class="mt-6 text-center">
                                    <h4 class="text-gray-600 text-21">Success !</h4>
                                    <p class="mt-1 text-gray-500">At vero eos et accusamus et iusto odio dignissimos ducimus
                                        qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et</p>
                                </div>

                                <div class="mt-5">
                                    <a href="{{ url('auth-login') }}"
                                        class="btn border-transparent bg-violet-500 w-full py-2.5 text-white shadow-md shadow-violet-200 dark:shadow-zinc-600">Back
                                        to Home</a>
                                </div>
                            </div>
