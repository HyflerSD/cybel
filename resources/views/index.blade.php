    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <!-- page title -->
                <x-page-title title="Dashbaord" pagetitle="index" />
                                                        ...
                                                        <div class="col-span-6">
                                                            <div>
                                                                <p
                                                                    ...
                                                                    Income</p>
                                                                <h5 class="mb-2 text-gray-800 dark:text-gray-100">$ 2632.46
                                                                </h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-span-6">
                                                            <div>
                                                                <p
                                                                    class="mb-2 text-gray-600 dark:text-zinc-100 uppercase text-11 leading-[16.5px]">
                                                                    Expenses</p>
                                                                <h5 class="mb-2 text-gray-800 dark:text-gray-100">-$ 924.38
                                                                </h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div dir="ltr" class="swiper login-slider bitcon-news">
                                            <div class="swiper-wrapper">
                                                <div class="mb-8 swiper-slide">
                                                    ...
                                                    <button type="button" href="{{ url('apps-invoices-list') }}"
                                    ...
                                    <div class="block tab-pane" id="buy-tab" role="tabpanel">
                                        <div class="ltr:float-right rtl:float-left ms-2">
                                            <h5 class="text-sm text-gray-700 dark:text-zinc-100"><i
                                                    class="mr-1 align-middle bx bx-wallet text-violet-500 text-16"></i> <a
                                                    href="#!"
                                                    class="underline text-reset underline-offset-2">$4335.23</a></h5>
                                        </div>
                                ...
                                <div class="table w-full">
                                    <ul>
                                        <li class="relative flex">
                                            ...
                                            <div class="shrink-0">
                                                <div class="w-20 mr-1 shrink-0 text-end">
                                                    <h6 class="mb-1 font-medium text-gray-700 dark:text-gray-100">+0.5 BTC
                                                    </h6>
                                            ...
                                            <div class="shrink-0">
                                                <div class="relative dropdown">
                                                    ...
                                                    <ul class="dropdown-view absolute top-auto z-50 hidden w-40 py-1.5 text-left list-none bg-white border border-gray-50/50 rounded shadow-lg dropdown-menu ltr:!right-0 ltr:!left-auto rtl:!left-0 rtl:!right-auto dark:bg-zinc-700 dark:border-zinc-600 bg-clip-padding"
                                                        aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <li class="relative flex">
                                            ...
                                            <div class="shrink-0">
                                                <div class="w-20 mr-1 shrink-0 text-end">
                                                    <h6 class="mb-1 font-medium text-gray-700 dark:text-gray-100">-20.5 ETH
                                                    </h6>
                                        ...
                                        <li class="relative flex">
                                            ...
                                            <div class="shrink-0">
                                                <div class="w-20 mr-1 shrink-0 text-end">
                                                    <h6 class="mb-1 font-medium text-gray-700 dark:text-gray-100">-1.5 LTC
                                                    </h6>
                                                    <div class="text-13 dark:text-zinc-100">$5791.45</div>
                                                </div>
                                            </div>
                                        ...
                                        <li class="relative flex">
                                            ...
                                            <div class="shrink-0">
                                                <div class="w-20 mr-1 shrink-0 text-end">
                                                    <h6 class="mb-1 font-medium text-gray-700 dark:text-gray-100">+.55 LTC
                                                    </h6>
